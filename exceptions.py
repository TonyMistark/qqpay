...
class QqClientException(QqException):
    """Qq API client exception class"""
    def __init__(self, errcode, errmsg, client=None,
                 request=None, response=None):
        super(QqClientException, self).__init__(errcode, errmsg)
        self.client = client
        self.request = request
        self.response = response


class InvalidSignatureException(QqException):
...
class APILimitedException(QqClientException):
    """Qq API call limited exception class"""
    pass


class InvalidAppIdException(QqException):
...
class QqOAuthException(QqClientException):
    """Qq OAuth API exception class"""
    pass


class QqPayException(QqClientException):
    """Qq Pay API exception class"""
    def __init__(self, return_code, result_code=None, return_msg=None,
        ...
        :param errmsg: 错误代码描述
        """
        super(QqPayException, self).__init__(
            errcode,
            errmsg,
            client,
            request,
